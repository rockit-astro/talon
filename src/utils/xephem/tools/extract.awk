...
#
# $Header: /cvsrep/torus/talon/GUI/xephem/tools/extract.awk,v 1.1.1.1 2001/04/19 21:12:06 ocaas Exp $
#
...
# @(#) $RCSfile: extract.awk,v $ $Date: 2001/04/19 21:12:06 $ $Revision: 1.1.1.1 $ $Name:  $
