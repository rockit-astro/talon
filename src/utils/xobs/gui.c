...
void mkGUI(char *version)
{
    ...
    XtVaSetValues(cur_w, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, skymap_w,
                  XmNrightAttachment, XmATTACH_WIDGET, NULL);
    ...
    XtVaSetValues(ctrl_w, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, XmNbottomAttachment,
                  XmATTACH_FORM, NULL);
    ...
    XtVaSetValues(cover_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, XmNrightAttachment,
                  XmATTACH_WIDGET, XmNrightWidget, dome_w, XmNrightOffset, 10, NULL);
    ...
    XtVaSetValues(status_w, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment,
                  ...
                  XmNrightWidget, cover_w, XmNrightOffset, 10, NULL);
...
void msg(char *fmt, ...)
{
    ...
    sprintf(utbuf, "%04d-%02d-%02dT%02d:%02d:%02d", tmp->tm_year + 1900, tmp->tm_mon + 1, tmp->tm_mday, tmp->tm_hour,
...
void guiSensitive(int whether)
{
    static Widget *batch_wp[] = {
        &g_w[TSERV_W], &g_w[TSTOW_W],  &g_w[TGOTO_W],   &g_w[TTRACK_W],  &g_w[CFHOME_W],
        &g_w[CFLIM_W], &g_w[CAUTOF_W], &g_w[CPADDLE_W], &g_w[CCNFOFF_W], &g_w[CCNFOFF_W],
    };
    int i;
...
static Widget mkCurrent(Widget main_w)
{
    ...
    static Ctrl ctrls[] = {
        {""}, {"RA(J2000)"}, {"Dec(J2000)"}, {"HA"}, {"Altitude"}, {"Azimuth"}, {"Focus (um)"},
    };
...
static Widget mkCover(Widget main_w)
{
    ...
    tbl_w = XtVaCreateManagedWidget("CVRC", xmRowColumnWidgetClass, f_w, XmNtopAttachment, XmATTACH_FORM,
                                    XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM,
                                    XmNrightAttachment, XmATTACH_FORM, XmNisAligned, False, XmNadjustMargin, False,
                                    XmNpacking, XmPACK_TIGHT, XmNspacing, 2, NULL);
...
static Widget mkControl(Widget main_w)
{
    ...
    static Ctrl ctrls[] = {
        ...
        {"Sounds", 1, soundCB, &g_w[CSOUND_W], "Toggle whether to make sounds while equipment is setting up"},
    };
    Widget fr_w, f_w;
    Widget tbl_w;
    Widget w;
...
static Widget mkInfo(Widget main_w)
{
    ...
    for (i = 0; i < XtNumber(l_w); i++)
    {
        l_w[i] = XtVaCreateManagedWidget("IL", xmTextFieldWidgetClass, lf_w, XmNbackground, uneditableColor, XmNcolumns,
                                         8, XmNcursorPositionVisible, False, XmNeditable, False, XmNmarginHeight, 1,
