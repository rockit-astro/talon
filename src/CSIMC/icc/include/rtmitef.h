;
; Set up CBOOT (CSROM) to start at $00:0000 and CS0 (CSRAM), to start
; at $02:0000.  Both CSes are set for 128K.  CS1 (CS_WRITE) is set for 
; 256K to write enable both RAM & ROM.
    LDD   #0x0004    ;at reset, the CSBOOT block size is 512k (pg. D-29)
                    ;(0x0002=16K, $0003=64K, $0004=128K, $0005=256K)
    STD   CSBARBT   ;Sets CSROM block size to 128k starting at page 0x00:
    LDD   #0x0204    ;Set CS0 (CSRAM) to 128K starting at page $02:
    ...
    STD   CSOR0     ;Set CS0 (CSRAM) options the same as CSBOOT
...
;
    ...
    CLR  CSPAR1     ;00 00 00 00 00 00 00 00:  CS10..CS2: Eclk, Digi outs
